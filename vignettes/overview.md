...
<img src="oolong_demo.gif" align="center" />
...
#> Quantiles of model precision: 0.2, 0.2375, 0.275, 0.3125, 0.35
#> P-value of the model precision (H0: Model precision is not better than random guess): 0.0825613207435173
#> Krippendorff's alpha: -0.100313479623825
#> K Precision: 0.5, 0, 0, 0, 1, 0.5, 0, 0, 0.5, 0, 0.5, 0, 0, 0.5, 0, 0, 0.5, 0.5, 0.5, 0.5
#> Mean TLO: -2.17
#> Median TLO: -2.8
#> Quantiles of TLO: -7.7138341189234, -3.43986691513599, -2.80077627907215, 0, 0
#> P-Value of the median TLO (H0: Median TLO is not better than random guess): 0.861333333333333
```
...
#> INFO  [22:27:13.470] early stopping at 50 iteration
oolong_test
#> An oolong test object with k = 20, 0 coded.
#> Use the method $do_word_intrusion_test() to do word intrusion test.
#> With 25 cases of topic intrusion test. 0 coded.
...
<img src="trump_coding.png" align="center" />
