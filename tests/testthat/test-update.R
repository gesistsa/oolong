...
test_that("check_oolong", {
    ...
    expect_error(check_oolong(wi(abstracts_stm)), NA)
    expect_error(check_oolong(witi(abstracts_stm, abstracts$text)), NA)
    expect_error(check_oolong(wsi(abstracts_stm)), NA)
    expect_error(check_oolong(gs(abstracts$text)), NA)
})

test_that("update_oolong; needless update", {
    skip_on_cran()
    expect_error(update_oolong(wi(abstracts_stm)))
    expect_error(update_oolong(witi(abstracts_stm, abstracts$text)))
    expect_error(update_oolong(wsi(abstracts_stm)))
