...
Please refer to the [overview](overview_gh.md) for an introduction to this package. If you use BTM, please refer to the [BTM Vignette](btm_gh.md).

## Citation

Please cite this package as:

Chan et al., (2020). oolong: An R package for validating  automated content analysis tools. Journal of Open Source Software, 5(55), 2461, [https://doi.org/10.21105/joss.02461](https://doi.org/10.21105/joss.02461)
