...
and topic intrusion tests, i.e. those created using
[`witi()`](https://gesistsa.github.io/oolong/reference/create_oolong.md)
online. If you need to do both tests, you need to deploy them as two
separate instances: one created using
[`wi()`](https://gesistsa.github.io/oolong/reference/create_oolong.md)
and another created using
[`ti()`](https://gesistsa.github.io/oolong/reference/create_oolong.md).
...
app.”](https://shiny.rstudio.com/articles/app-formats.html) Experienced
Shiny users might have their preferred method of deploying this app to
whatever Shiny server they can master.
...
e.g. *wsi_test*. You probably can keep other default settings and push
the **Publish** button to initialize the deployment process.

![](figures/deploying_shinyappsio.png)
