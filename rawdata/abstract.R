...
usethis::use_data(newsgroup_dfm, overwrite = TRUE)

require(quanteda.textmodels)

newsgroup_nb <- textmodel_nb(newsgroup_dfm, docvars(newsgroup_dfm, "group"), distribution = "Ber")

usethis::use_data(newsgroup_nb, overwrite = TRUE)
